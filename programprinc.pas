...
G1, G2: Boolean; // T=terminé, G=gagné
...
finDePartie(grille1,G1);// regarde si la partie est terminée
finDePartie(grille2,G2);
until G1 or G2;// On répète ces actions jusqu'à ce que la partie soit terminée
