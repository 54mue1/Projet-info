...
begin
    ...
    case touche of
        ...
        E:  if not(grille2[curs1.y][curs1.x].drapeau)   then grille1[curs1.y][curs1.x].drapeau:=True;  // pose un drapeau sur la case du curseur
        ...
        P :  if not(grille1[curs2.y][curs2.x].drapeau)   then grille2[curs2.y][curs2.x].drapeau:=True;  // pose un drapeau sur la case du curseur 
end;
end;
end.
