...
begin
    ...
    case touche of
        ...
        E:  if (grille2[curs1.y][curs1.x].drapeau)   then grille1[curs1.y][curs1.x].drapeau:=False else grille1[curs1.y][curs1.x].drapeau:=True ;  // enlève un drapeau s'il y en a déjà, sinon en ajoute un
        ...
        P :  if (grille1[curs2.y][curs2.x].drapeau)   then grille2[curs2.y][curs2.x].drapeau:=False else grille2[curs2.y][curs2.x].drapeau:=True;  // pose un drapeau sur la case du curseur 
end;
end;
end.
